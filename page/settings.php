...
if ($proses == "update") {
    ...
    if (!empty($nama_gambar)) {
        ...
        if ($cekgambar['gambar'] == 'gambar_pp/default.png') { //gambar akan dihapus jika didatabase sebelumnya sudah ada gambar
    ...
    $update = mysqli_query($koneksi, "UPDATE admin SET nama='$nama', username='$username', password='$password' WHERE idadmin='$idadmin'");
    if ($update) {
